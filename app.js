...
function getUserInput() {
  ...
  let yourAvgText = `Based on the average it will probably take you another ${
    user.total} hours or ${user.avgWeeks} weeks. This means that you would finish on ${date.now}`;
  ...
  let yourMaxText = `Based on the max on record it could take you another ${
    user.maxTotal} hours or ${user.maxWeeks} weeks. This means that you would finish on ${maxDate.now}`;
